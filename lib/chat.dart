                ...
                child: Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      ...
                      setState(() {
                        Chat_data[widget.index].MSG.add(newMsg);
                      });
                ...
                child: Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      ...
                      Chat_data[widget.index].MSG.add(new_msg);
                      // generate new msg request to server
                    },
                    color: Colors.grey,
                  ),
        ...
        children: <Widget>[
          Flexible(
            child: Container(
              ...
              itemCount: Chat_data[widget.index].MSG.length,
              itemBuilder: (context, i) {
                var parsedDate =
                    DateTime.parse(Chat_data[widget.index].MSG[i].date);
//                    print("DATE:" + parsedDate.toIso8601String());
//                    print("ZONE: " + parsedDate.millisecond.toString());
                Chat_data[widget.index]
                    .MSG
                    .sort((message a, message b) => (a.date).compareTo(b.date));
                return Chat_data[widget.index].MSG[i].sender ==
                        Chat_data[widget.index].sender
                    ? Container(
                        child: Column(
                          children: <Widget>[
                            SizedBox(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        Chat_data[widget.index].MSG[i].data,
                                        style: TextStyle(
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.asset(
                                      Chat_data[widget.index].imageUrl,
                    ...
                    : Container(
                        child: Column(
                          children: <Widget>[
                              ...
                              child: Align(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.only(
                                      topRight: Radius.elliptical(15, 35)),
                                  child: Container(
                                      width: 200.0,
                                      decoration: BoxDecoration(
                            ...
                            (Chat_data[widget.index].MSG.length) != i + 1
                                ? Chat_data[widget.index].MSG[i].sender !=
                                        Chat_data[widget.index]
                                            .MSG[i + 1]
                                            .sender
                                    ? Container(
